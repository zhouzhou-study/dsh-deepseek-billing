...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function PricingBody(props) {
      ...
      // 「历史用量」区块：扫本地会话日志，按**当时生效的价格政策**归类每次调用。
      // 标记 data-dsh-billing-section="usage" 供自定义 CSS 定位（见 README）。
      if (props.usage !== null && props.usage !== void 0) {
        var usageInfo = props.usage;
        var scanned = usageInfo.status === "ready" || usageInfo.status === "stale";
        rows.push(h("div", { key: "usage-status", "data-dsh-billing-section": "usage", style: MUTED },
          scanned
          ...
          return h("div", { key: key, style: { borderLeft: "2px solid var(--dsw-alias-border-l1)", paddingLeft: 6 } },
            h("div", { style: { display: "flex", alignItems: "center", gap: 6, fontSize: 11, fontWeight: 600, lineHeight: "16px", flexWrap: "wrap" } },
              ...
              (function () {
                ...
                return h("span", { "data-dsh-billing-section": "usage", style: { marginLeft: "auto", fontVariantNumeric: "tabular-nums" } },
